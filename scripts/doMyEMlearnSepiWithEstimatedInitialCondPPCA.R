...
processAll <- function() {
    ...
    resultsFilnamePattern <- "results/sepiDObs%02dMyEM_estimation.RData"
    ...
    logLikFigFilename <- "figures/sepiMmyEM_logLik.html"
    ...
    AFigFilename <- "figures//sepiMyEM_A.html"
    ...
    CFigFilename <- "figures//sepiMyEM_C.html"
    ...
    GammaFigFilename <- "figures//sepiMyEM_varGamma.html"
    ...
    SigmaFigFilename <- "figures//sepiMyEM_Sigma.html"
    ...
    pPlotly <- ggplotly(p)
    latentsFigFilename <- "figures//sepiMyEM_Latents.html"
