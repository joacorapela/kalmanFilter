...
processAll <- function() {
    xlab <- "x"
    ylab <- "y"
    simConfigFilename <- "data/multipleCirclesDimState6DimObs25_simulation_metaData.ini"
    ...
    res <- simulateLDSwithOffsetsAndInputs(B=B, u=u, C=C, c=cHist, Q=Q, x00=x00, V00=V00, Z=Z, a=a, D=D, d=dHist, R=R)
